...
##
##  For the LCR-F2, written in Octobre 2014 by Marc Kraus
##
###############################################################################
...
var pilot_type   = "Aircraft/LCR/Models/LCR-F2.xml";
var copilot_type = "Aircraft/LCR/Models/LCR-P.xml";

############################ PROPERTIES MP ###########################

var TDM_mpp     = "sim/multiplay/generic/string[1]";

var speed		= 	["instrumentation/LCR/speed-indicator/speed-limiter-switch",
					 "instrumentation/LCR/speed-indicator/speed-limiter",
					 "instrumentation/LCR/speed-indicator/speed-meter",
					 "instrumentation/LCR/speed-indicator/selection"];		 
...
var copilot_connect_pilot = func (pilot) {
  ...
  return [
     ...
     DCT.Translator.new(pilot.getNode("sim/multiplay/generic/float[3]"),
                         props.globals.getNode("/controls/LCR/driver-up", 1),1),
